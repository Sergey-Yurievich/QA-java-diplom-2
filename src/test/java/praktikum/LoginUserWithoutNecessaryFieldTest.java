...
public class LoginUserWithoutNecessaryFieldTest {
    ...
    public LoginUserWithoutNecessaryFieldTest (UserCredentials userCredentials, int expectedStatus, String expectedErrorMessage) {
